    ...
    <main className="m-auto max-w-lg space-y-6">
      ...
      <section>
        <form action={formAction} className="space-y-2">
          ...
          <Input name="title" placeholder="Course title" minLength={8} />
          <Textarea name="description" placeholder="Course descriptions" minLength={1} />
          <Input name="price" placeholder="Course prices" type="number" min={500} />
